; Listing generated by Microsoft (R) Optimizing Compiler Version 19.29.30137.0 
	...
	TITLE	C:\Users\romra\Documents\Cours\JV\Intelligence artificielle pour les jeux vidéo\Mini Projet\VS2015\Buckland_Chapter7 to 10_Raven\Debug\BaseGameEntity.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG159885 DB	'invalid argument', 00H
	ORG $+3
$SG159886 DB	'%s', 00H
	ORG $+1
$SG159887 DB	'C:\Program Files (x86)\Microsoft Visual Studio\2019\Comm'
	DB	'unity\VC\Tools\MSVC\14.29.30133\include\xmemory', 00H
$SG159888 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H
$SG159889 DB	's', 00H, 't', 00H, 'd', 00H, ':', 00H, ':', 00H, '_', 00H
	...
	DB	00H
	ORG $+2
$SG159890 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+2
$SG155340 DB	'<BaseGameEntity::SetID>: invalid ID', 00H
	ORG $+4
$SG155341 DB	'C', 00H, ':', 00H, '\', 00H, 'U', 00H, 's', 00H, 'e', 00H
	...
	DB	00H
	ORG $+4
$SG155342 DB	'(', 00H, 'v', 00H, 'a', 00H, 'l', 00H, ' ', 00H, '>', 00H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\romra\Documents\Cours\JV\Intelligence artificielle pour les jeux vidéo\Mini Projet\VS2015\Common\Game\BaseGameEntity.cpp
...
; 26   :   assert ( (val >= m_iNextValidID) && "<BaseGameEntity::SetID>: invalid ID");
	...
	jl	SHORT $LN3@SetID
	mov	ecx, OFFSET $SG155340
	test	ecx, ecx
	jne	SHORT $LN4@SetID
$LN3@SetID:
	push	26					; 0000001aH
	push	OFFSET $SG155341
	push	OFFSET $SG155342
	call	__wassert
