; Listing generated by Microsoft (R) Optimizing Compiler Version 19.29.30137.0 
	...
	TITLE	C:\Users\romra\Documents\Cours\JV\Intelligence artificielle pour les jeux vidéo\Mini Projet\VS2015\Buckland_Chapter7 to 10_Raven\Debug\Goal_FollowPath.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG172392 DB	'<Goal_FollowPath::Activate>: Unrecognized edge type', 00H
$SG182429 DB	'invalid argument', 00H
	ORG $+3
$SG182430 DB	'%s', 00H
	ORG $+5
$SG182431 DB	'C:\Program Files (x86)\Microsoft Visual Studio\2019\Comm'
	DB	'unity\VC\Tools\MSVC\14.29.30133\include\xmemory', 00H
$SG182432 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H
$SG182433 DB	's', 00H, 't', 00H, 'd', 00H, ':', 00H, ':', 00H, '_', 00H
	...
	DB	00H
	ORG $+2
$SG182434 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+2
$SG182689 DB	'C:\Program Files (x86)\Microsoft Visual Studio\2019\Comm'
...
PUBLIC	??_C@_1IO@HPCDNOMM@?$AAs?$AAt?$AAd?$AA?3?$AA?3?$AAl?$AAi?$AAs?$AAt?$AA?$DM?$AAc?$AAl?$AAa?$AAs?$AAs@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1IO@HPCDNOMM@?$AAs?$AAt?$AAd?$AA?3?$AA?3?$AAl?$AAi?$AAs?$AAt?$AA?$DM?$AAc?$AAl?$AAa?$AAs?$AAs@
CONST	SEGMENT
??_C@_1IO@HPCDNOMM@?$AAs?$AAt?$AAd?$AA?3?$AA?3?$AAl?$AAi?$AAs?$AAt?$AA?$DM?$AAc?$AAl?$AAa?$AAs?$AAs@ DB 's'
	DB	00H, 't', 00H, 'd', 00H, ':', 00H, ':', 00H, 'l', 00H, 'i', 00H
	DB	's', 00H, 't', 00H, '<', 00H, 'c', 00H, 'l', 00H, 'a', 00H, 's'
	...
	DB	'e', 00H, '>', 00H, ' ', 00H, '>', 00H, ':', 00H, ':', 00H, 'f'
...
$LN7@Allocate_m:
	push	OFFSET $SG182429
	push	OFFSET $SG182430
	push	0
	push	142					; 0000008eH
	push	OFFSET $SG182431
	push	2
	call	__CrtDbgReport
...
; 718  :     void _Attach_head(_List_val<_Val_types>& _List_data) {
...
; 719  :         _Alloc_construct_ptr<_Alnode> _Newnode(_Al);
...
; 721  :         const auto _Local_added = _STD exchange(_Added, size_type{0});
...
; 722  :         if (_Local_added == 0) {

	cmp	DWORD PTR __Local_added$[ebp], 0
	jne	SHORT $LN2@Attach_hea

; 723  :             _Construct_in_place(_Newnode._Ptr->_Next, _Newnode._Ptr);
...
; 724  :             _Construct_in_place(_Newnode._Ptr->_Prev, _Newnode._Ptr);
...
; 726  :             const auto _Local_head = _Head;

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+12]
	mov	DWORD PTR __Local_head$4[ebp], eax

; 727  :             const auto _Local_tail = _Tail;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+8]
	mov	DWORD PTR __Local_tail$3[ebp], edx

; 728  :             _Construct_in_place(_Newnode._Ptr->_Next, _Local_head);
...
; 729  :             _Construct_in_place(_Newnode._Ptr->_Prev, _Local_tail);
...
; 730  :             _Construct_in_place(_Local_head->_Prev, _Newnode._Ptr);
...
; 731  :             _Construct_in_place(_Local_tail->_Next, _Newnode._Ptr);
...
; 732  :         }
; 733  : 
; 734  :         _List_data._Mysize = _Local_added;

	mov	edx, DWORD PTR __List_data$[ebp]
	mov	eax, DWORD PTR __Local_added$[ebp]
	mov	DWORD PTR [edx+8], eax

; 735  :         _List_data._Myhead = _Newnode._Release();
...
; 659  :     void _Append_range_unchecked(_InIt _First, const _Sentinel _Last) {
...
; 660  :         // Append the values in [_First, _Last)
; 661  :         if (_First == _Last) { // throws
...
; 663  :         }
; 664  : 
; 665  :         _Alloc_construct_ptr<_Alnode> _Newnode(_Al);
...
; 667  :             _Newnode._Allocate(); // throws

	lea	ecx, DWORD PTR __Newnode$[ebp]
	call	?_Allocate@?$_Alloc_construct_ptr@V?$allocator@U?$_List_node@VPathEdge@@PAX@std@@@std@@@std@@QAEXXZ ; std::_Alloc_construct_ptr<std::allocator<std::_List_node<PathEdge,void *> > >::_Allocate

; 668  :             _Alnode_traits::construct(_Al, _STD addressof(_Newnode._Ptr->_Myval), *_First); // throws
...
; 669  :             const auto _Newhead = _STD exchange(_Newnode._Ptr, pointer{});
...
; 677  :             _Newnode._Allocate(); // throws

	lea	ecx, DWORD PTR __Newnode$[ebp]
	call	?_Allocate@?$_Alloc_construct_ptr@V?$allocator@U?$_List_node@VPathEdge@@PAX@std@@@std@@@std@@QAEXXZ ; std::_Alloc_construct_ptr<std::allocator<std::_List_node<PathEdge,void *> > >::_Allocate

; 678  :             _Alnode_traits::construct(_Al, _STD addressof(_Newnode._Ptr->_Myval), *_First); // throws
...
; 679  :             _Construct_in_place(_Tail->_Next, _Newnode._Ptr);
...
; 680  :             _Construct_in_place(_Newnode._Ptr->_Prev, _Tail);
...
; 681  :             _Tail = _STD exchange(_Newnode._Ptr, pointer{});
...
; 741  :         }
; 742  : 
; 743  :         _Construct_in_place(_Head->_Prev, pointer{});
...
; 744  :         _Construct_in_place(_Tail->_Next, pointer{});
...
; 747  :             value_type::_Freenode(_Al, _STD exchange(_Subject, _Subject->_Next));
...
; 624  :     explicit _List_node_insert_op2(_Alnode& _Al_) : _Al(_Al_), _Added(0) {}
...
; 861  :     void _Construct_range_unchecked(_Iter _First, _Iter _Last) {
...
; 862  :         auto&& _Alproxy = _GET_PROXY_ALLOCATOR(_Alnode, _Getal());
...
; 863  :         _Container_proxy_ptr<_Alty> _Proxy(_Alproxy, _Mypair._Myval2);
...
; 864  :         _List_node_insert_op2<_Alnode> _Appended(_Getal());
...
; 866  :         _Appended._Attach_head(_Mypair._Myval2);
...
; 246  :     _NODISCARD pointer operator->() const noexcept {
...
; 247  :         return pointer_traits<pointer>::pointer_to(**this);
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\romra\Documents\Cours\JV\Intelligence artificielle pour les jeux vidéo\Mini Projet\VS2015\Buckland_Chapter7 to 10_Raven\goals\Goal_FollowPath.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\romra\Documents\Cours\JV\Intelligence artificielle pour les jeux vidéo\Mini Projet\VS2015\Buckland_Chapter7 to 10_Raven\goals\Goal_FollowPath.cpp
...
$LN11@front:
	...
	push	1209					; 000004b9H
	push	OFFSET ??_C@_1MK@BCBJPFOJ@?$AAC?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe@
	push	OFFSET ??_C@_1IO@HPCDNOMM@?$AAs?$AAt?$AAd?$AA?3?$AA?3?$AAl?$AAi?$AAs?$AAt?$AA?$DM?$AAc?$AAl?$AAa?$AAs?$AAs@
...
; 1119 :     _Unchecked_const_iterator _Unchecked_end() const noexcept {
...
; 1111 :     _Unchecked_const_iterator _Unchecked_begin() const noexcept {
...
; 872  :         : _Mypair(_One_then_variadic_args_t{}, _Alnode_traits::select_on_container_copy_construction(_Right._Getal())) {
...
; 873  :         _Construct_range_unchecked(_Right._Unchecked_begin(), _Right._Unchecked_end());
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\romra\Documents\Cours\JV\Intelligence artificielle pour les jeux vidéo\Mini Projet\VS2015\Buckland_Chapter7 to 10_Raven\navigation\PathEdge.h
