; Listing generated by Microsoft (R) Optimizing Compiler Version 19.29.30137.0 
	...
	TITLE	C:\Users\romra\Documents\Cours\JV\Intelligence artificielle pour les jeux vidéo\Mini Projet\VS2015\Buckland_Chapter7 to 10_Raven\Debug\WindowUtils.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG159308 DB	'invalid argument', 00H
	ORG $+3
$SG159309 DB	'%s', 00H
	ORG $+1
$SG159310 DB	'C:\Program Files (x86)\Microsoft Visual Studio\2019\Comm'
	DB	'unity\VC\Tools\MSVC\14.29.30133\include\xmemory', 00H
$SG159311 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H
$SG159312 DB	's', 00H, 't', 00H, 'd', 00H, ':', 00H, ':', 00H, '_', 00H
	...
	DB	00H
	ORG $+2
$SG159313 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+2
$SG154157 DB	'Error', 00H
	ORG $+2
$SG154161 DB	'Error', 00H
	ORG $+2
$SG154260 DB	'*.*', 00H
$SG154261 DB	'All Files (*.*)', 00H
$SG154262 DB	'*.', 00H
CONST	ENDS
...
; 3873 :             [](_Elem* const _New_ptr, const _Elem* const _Old_ptr, const size_type _Old_size, const _Elem _Ch) {
...
; 3874 :                 _Traits::copy(_New_ptr, _Old_ptr, _Old_size);
...
$LN7@Allocate_m:
	push	OFFSET $SG159308
	push	OFFSET $SG159309
	push	0
	push	142					; 0000008eH
	push	OFFSET $SG159310
	push	2
	call	__CrtDbgReport
	add	esp, 24					; 00000018H
	cmp	eax, 1
...
$LN12@Allocate_m:
	push	0
	push	142					; 0000008eH
	push	OFFSET $SG159311
	push	OFFSET $SG159312
...
; 193  :     basic_ostream& __CLR_OR_THIS_CALL operator<<(ios_base&(__cdecl* _Pfn)(ios_base&) ) { // call ios_base manipulator
...
; 4789 :     basic_string<_Elem, _Traits, _Alloc>&& _Left, const _Elem _Right) {
...
; 4735 :     const basic_string<_Elem, _Traits, _Alloc>& _Left, const _Elem _Right) {
...
; 4736 :     const auto _Left_size = _Left.size();

	mov	ecx, DWORD PTR __Left$[ebp]
	call	?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::size
	mov	DWORD PTR __Left_size$[ebp], eax

; 4737 :     if (_Left_size == _Left.max_size()) {
...
; 4739 :     }
; 4740 : 
; 4741 :     return {_String_constructor_concat_tag{}, _Left, _Left.c_str(), _Left_size, _STD addressof(_Right), 1};
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\romra\Documents\Cours\JV\Intelligence artificielle pour les jeux vidéo\Mini Projet\VS2015\Common\misc\Stream_Utility_Functions.h
...
; Function compile flags: /Odtp /RTCsu
; File C:\Users\romra\Documents\Cours\JV\Intelligence artificielle pour les jeux vidéo\Mini Projet\VS2015\Common\misc\WindowUtils.cpp
...
; 108  :   std::string filter = defaultFileTypeDescription + '\0' + "*." + defaultFileExtension + '\0' +
	...
	push	0
	push	0
	push	OFFSET $SG154260
	push	0
	push	OFFSET $SG154261
	push	0
	mov	eax, DWORD PTR _defaultFileExtension$[ebp]
	push	eax
	push	OFFSET $SG154262
	push	0
	mov	ecx, DWORD PTR _defaultFileTypeDescription$[ebp]
	push	ecx
...
; 3861 :     _CONSTEXPR20_CONTAINER void push_back(const _Elem _Ch) { // insert element at end
...
; 3865 :             _Elem* const _Ptr       = _Mypair._Myval2._Myptr();
