; Listing generated by Microsoft (R) Optimizing Compiler Version 19.29.30137.0 
	...
	TITLE	C:\Users\romra\Documents\Cours\JV\Intelligence artificielle pour les jeux vidéo\Mini Projet\VS2015\Buckland_Chapter7 to 10_Raven\Debug\Raven_Feature.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG198116 DB	'invalid argument', 00H
?piecewise_construct@std@@3Upiecewise_construct_t@1@B	ORG $+1 ; std::piecewise_construct
	ORG $+2
$SG198117 DB	'%s', 00H
	ORG $+1
$SG198118 DB	'C:\Program Files (x86)\Microsoft Visual Studio\2019\Comm'
	DB	'unity\VC\Tools\MSVC\14.29.30133\include\xmemory', 00H
$SG198119 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H
$SG198120 DB	's', 00H, 't', 00H, 'd', 00H, ':', 00H, ':', 00H, '_', 00H
	...
	DB	00H
	ORG $+2
$SG198121 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+2
$SG198377 DB	'C:\Program Files (x86)\Microsoft Visual Studio\2019\Comm'
	DB	'unity\VC\Tools\MSVC\14.29.30133\include\xlocale', 00H
$SG184110 DB	'RailGun_MaxRoundsCarried', 00H
	ORG $+3
$SG184112 DB	'RocketLauncher_MaxRoundsCarried', 00H
$SG184114 DB	'ShotGun_MaxRoundsCarried', 00H
	ORG $+3
$SG184117 DB	'trying to calculate  of unknown weapon', 00H
	ORG $+1
...
; 1492 :     _CONSTEXPR20_DYNALLOC void _Emplace_back(_Types&&... _Vals) {
...
; 1493 :         // construct a new element at *_Last and increment
; 1494 :         _Construct_in_place(*_Last, _STD forward<_Types>(_Vals)...);
...
; 1498 :     constexpr _NoThrowFwdIt _Release() { // suppress any exception handling backout and return _Last
...
; 1487 :     _CONSTEXPR20_DYNALLOC ~_Uninitialized_backout() {
...
; 1488 :         _Destroy_range(_First, _Last);
...
; 1480 :     constexpr explicit _Uninitialized_backout(_NoThrowFwdIt _Dest) : _First(_Dest), _Last(_Dest) {}
...
$LN7@Allocate_m:
	push	OFFSET $SG198116
	push	OFFSET $SG198117
	push	0
	push	142					; 0000008eH
	push	OFFSET $SG198118
	push	2
	call	__CrtDbgReport
	add	esp, 24					; 00000018H
	cmp	eax, 1
...
$LN12@Allocate_m:
	push	0
	push	142					; 0000008eH
	push	OFFSET $SG198119
	push	OFFSET $SG198120
	push	OFFSET $SG198121
	call	__invalid_parameter
	add	esp, 20					; 00000014H
	xor	ecx, ecx
...
; 1774 : void uninitialized_fill(const _NoThrowFwdIt _First, const _NoThrowFwdIt _Last, const _Tval& _Val) {
...
; 1775 :     // copy _Val throughout raw [_First, _Last)
; 1776 :     _Adl_verify_range(_First, _Last);
...
; 1777 :     auto _UFirst      = _Get_unwrapped(_First);
...
; 1778 :     const auto _ULast = _Get_unwrapped(_Last);
...
; 1779 :     if constexpr (_Fill_memset_is_safe<_Unwrapped_t<const _NoThrowFwdIt&>, _Tval>) {
; 1780 :         _Fill_memset(_UFirst, _Val, static_cast<size_t>(_ULast - _UFirst));
; 1781 :     } else {
; 1782 :         if constexpr (_Fill_zero_memset_is_safe<_Unwrapped_t<const _NoThrowFwdIt&>, _Tval>) {
; 1783 :             if (_Is_all_bits_zero(_Val)) {
; 1784 :                 _Fill_zero_memset(_UFirst, static_cast<size_t>(_ULast - _UFirst));
; 1785 :                 return;
; 1786 :             }
; 1787 :         }
; 1788 : 
; 1789 :         _Uninitialized_backout<_Unwrapped_t<const _NoThrowFwdIt&>> _Backout{_UFirst};
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\romra\Documents\Cours\JV\Intelligence artificielle pour les jeux vidéo\Mini Projet\VS2015\Buckland_Chapter7 to 10_Raven\goals\Raven_Feature.cpp
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\romra\Documents\Cours\JV\Intelligence artificielle pour les jeux vidéo\Mini Projet\VS2015\Common\Script\scriptor.h
